...
export const metadata: Metadata = generatePageMetadata({
  ...
  description: 'Explore high-value investment opportunities across real estate, home services, artificial intelligence, and marketing & advertising in Minnesota.',
  path: '/minnesota',
  keywords: [
