...
export const siteConfig = {
  ...
  domain: 'alset.so',
  url: 'https://alset.so',
  description: 'Minnesota private investment company combining capital, creativity, and technology across real estate, home services, healthcare, robotics, and software.',
